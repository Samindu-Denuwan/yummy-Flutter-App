...
late LatLng _initialPosition = const LatLng(7.132988527485233, 79.88856944968506);
...
@override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:  AppBar(
        title: BigText(text: "Add Address" , color: Colors.white, fontWeight: FontWeight.w500, size: 20,),
        centerTitle: true,
      ...
      bottomNavigationBar: GetBuilder<LocationController>(
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            child: Center(
                child: BigText(
                  text: "Save Address", color: Colors.white,)),
          ),
        );
      },),
    );
